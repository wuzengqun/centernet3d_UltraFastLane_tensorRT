...
def main(args):
    ...
    builder.create_network(args.onnx, input_shapes=dict(
        input=dict(min_shape=[1, 3, 384, 1280],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--onnx", default="./Monodle_centerNet3D.onnx", help="The input ONNX model file to load")
    parser.add_argument("--engine", default="./Monodle_centerNet3D_int8.trt", help="The output path for the TRT engine")
    parser.add_argument(
        "-p",
        "--precision",
        default="int8",
